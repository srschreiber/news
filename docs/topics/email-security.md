...
- <span class="imp imp-3" title="Importance 3/5" aria-label="Importance 3 of 5"><i class="on"></i><i class="on"></i><i class="on"></i><i></i><i></i></span> [DeadLock ransomware uses decentralized infrastructure for operations](../news/email-security/2026-08-10.md#deadlock-ransomware-uses-decentralized-infrastructure-for-operations)
